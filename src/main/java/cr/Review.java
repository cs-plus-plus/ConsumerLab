...
public class Review {
  ...
  /**
   * Methods for students to implement:
   */
   ...
   *
   * @param fileName the name of the file containing the original review text, pos a boolean if the review should be positive
